...
if __name__ == "__main__":
    ...
    for i in set_ids:
        ...
        print(f"unzipping {ori_zip_file}")
        os.system(f"unzip -qq {ori_zip_file} -d {unzip_dir}")
        print(f"{ori_zip_file} is done.")
        ...
        for sub_zip in sub_zips:
            ...
            os.system(f"unzip -qq {src_path} -d {des_dir}")
            print(f"{sub_zip} is done.")
