...
class LaSOTDataset(BaseDataset):
    ...
    def _construct_sequence(self, sequence_name):
        ...
        anno_path = f'{self.base_path}/{class_name}/{sequence_name}/groundtruth.txt'

        ground_truth_rect = load_text(anno_path, delimiter=',', dtype=np.float64)

        occlusion_label_path = (
            f'{self.base_path}/{class_name}/{sequence_name}/full_occlusion.txt'
        )


        # NOTE: pandas backed seems super super slow for loading occlusion/oov masks
        full_occlusion = load_text(
            occlusion_label_path, delimiter=',', dtype=np.float64, backend='numpy'
        )


        out_of_view_label_path = (
            f'{self.base_path}/{class_name}/{sequence_name}/out_of_view.txt'
        )
        ...
        frames_path = f'{self.base_path}/{class_name}/{sequence_name}/img'
